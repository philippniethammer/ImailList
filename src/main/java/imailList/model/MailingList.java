...
public class MailingList {
	...
	@DatabaseField
	private boolean preventMultipleSends;
	...
	public boolean isPreventMultipleSends() {
		return preventMultipleSends;
	}

	public void setPreventMultipleSends(boolean preventMultipleSends) {
		this.preventMultipleSends = preventMultipleSends;
	}
